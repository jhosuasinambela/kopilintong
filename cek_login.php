...
if($cek > 0){
	...
	header("location:https://kopilintong.herokuapp.com/Admin/");
}else if($cek2 > 0){
	$pembeli='';
	...
	$_SESSION['username'] = $username;
	$_SESSION['status'] = "login";
	header("location:https://kopilintong.herokuapp.com/User/");
}else{
	header("location:https://kopilintong.herokuapp.com/");
}
?>
