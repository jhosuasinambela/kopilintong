  ...
  <div class="container rounded" style="background-color: white;">
    ...
    <div class="row mt-4 mb-3">
      ...
      <div class="col-lg-9 mb-4">
        ...
        <form action="tambahartikel.php" name="sentMessage" id="contactForm" method="post" novalidate enctype="multipart/form-data">
          ...
          <div class="control-group form-group">
            <div class="controls">
              <label>Isi:</label>
              <textarea rows="10" cols="100" class="form-control" name="isi"></textarea>
            </div>
          </div>
