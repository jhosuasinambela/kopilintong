    ...
    <div class="row mt-4 mb-3">
      ...
      <div class="col-lg-3 mb-4">
        <div class="list-group">
          ...
          <a href="sidebar2.php" class="list-group-item active">Pesanan</a>
          <a href="sidebar6.php" class="list-group-item">Kopi</a>
        </div>
      </div>
      <!-- Content Column -->
      <div class="col-lg-9 mb-4">
        <h2 class="mt-4">Pesanan</h2>
        <div class="row bg-faded" style="border-radius: 10px;" >
          <div class="col-8">
            <ul class="list-group mb-4">
              ...
              <?php 
                include 'koneksi.php';
                $query=mysqli_query($koneksi,"SELECT x.nama AS nama,x.harga AS harga,y.jumlah AS jumlah1,x.harga*y.jumlah AS jumlah, x.id as id FROM detail Y INNER JOIN barang X ON y.id_barang=x.id;");
                while ($hasil=$query->fetch_assoc()) {
              ?>
              <li class="list-group-item mb-3">
                <?=$hasil['nama']?>
                <a href="update.php?id=<?=$hasil['id'];?>" class="badge badge-primary float-right ml-1">Kirim</a>
              </li>
            <?php } ?>
            </ul>
          </div>
