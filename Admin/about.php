    ...
    <div class="row">
      <div class="col-lg-4 mb-4">
        <div class="card h-100 text-center">
          ...
          <div class="card-body">
            <h4 class="card-title">Winda Sinurat</h4>
            <h6 class="card-subtitle mb-2 text-muted">Project Manager</h6>
            <p class="card-text">"Stop yelling start doing"</p>
          </div>
      ...
      <div class="col-lg-4 mb-4">
        <div class="card h-100 text-center">
          <img class="card-img-top" src="http://placehold.it/750x450" alt="">
          <div class="card-body">
            <h4 class="card-title">Rafika Tampubolon</h4>
            <h6 class="card-subtitle mb-2 text-muted">Analyst</h6>
            <p class="card-text">"Aku kamu dia"</p>
          </div>
          <div class="card-footer">
            <a href="#">113180xx</a>
          </div>
      ...
      <div class="col-lg-4 mb-4">
        <div class="card h-100 text-center">
          <img class="card-img-top" src="http://placehold.it/750x450" alt="">
          <div class="card-body">
            <h4 class="card-title">Lestari</h4>
            <h6 class="card-subtitle mb-2 text-muted">Analyst</h6>
            <p class="card-text">"Aku adeknya Juan"</p>
          </div>
          <div class="card-footer">
            <a href="#">113180xx</a>
          </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-4 mb-4">
        <div class="card h-100 text-center">
          <img class="card-img-top" src="http://placehold.it/750x450" alt="">
          <div class="card-body">
            <h4 class="card-title">Joshua Silalahi</h4>
            <h6 class="card-subtitle mb-2 text-muted">Design</h6>
            <p class="card-text">"Tetaplah menjadi bintang di langit"</p>
          </div>
          <div class="card-footer">
            <a href="#">113180xx</a>
          </div>
      ...
      <div class="col-lg-4 mb-4">
        <div class="card h-100 text-center">
          <img class="card-img-top" src="http://placehold.it/750x450" alt="">
          <div class="card-body">
            <h4 class="card-title">Fedrick Sulaiman</h4>
            <h6 class="card-subtitle mb-2 text-muted">Programmer</h6>
            <p class="card-text">"Born to be programmer"</p>
          </div>
          <div class="card-footer">
            <a href="#">11317049</a>
          </div>
